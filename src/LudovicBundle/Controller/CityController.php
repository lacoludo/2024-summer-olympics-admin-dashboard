...
class CityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $cities = $em->getRepository('LudovicBundle:City')->findAll();

        return $this->render('LudovicBundle:city:index.html.twig', array(
            'cities' => $cities,
        ));
    }
    ...
    {
        $city = new City();
        $form = $this->createForm('LudovicBundle\Form\CityType', $city);
        ...
        return $this->render('LudovicBundle:city:new.html.twig', array(
            'city' => $city,
    ...
    public function showAction(City $city)
    {
        ...
        return $this->render('LudovicBundle:city:show.html.twig', array(
            'city' => $city,
    ...
    {
        $deleteForm = $this->createDeleteForm($city);
        $editForm = $this->createForm('LudovicBundle\Form\CityType', $city);
        ...
        return $this->render('LudovicBundle:city:edit.html.twig', array(
            'city' => $city,
